  ...
  return (
    <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center border-2 rounded-lg border-gray-200 py-10 px-20'>
      ...
      <label className="input input-bordered flex items-center gap-2 mt-4">
        ...
        <input type="text" className="grow" placeholder="Nickname" value={nickname} onChange={(e) => setUsername(e.target.value)} />
      </label>
      ...
      <CustomButton text='Registrarse' style="btn btn-active btn-neutral mt-4" fn={() => { }} type='submit' />
      <Link className="btn btn-active btn-link" to={'/login'}>Iniciar Sesión</Link>
    </form>
  );
};
